...
{
    public class StageThree : GameScreen
    {
        #region STAGE1 VARS
        ...
        #endregion
        #region CONSTRUCTOR
        public StageThree(ContentManager content)
        {
        ...
        public override void LoadContent()
        {
            ...
            //enemyhit
            jejehit = content.Load<Texture2D>("Sprites/tripodhit");
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (!gameEnd)
            {
                ...
                if (player.life == 0)
                {
                    ScreenManager.AddScreen(new WinScreen(content,"stateThree"));
                    gameEnd = true;
                }
            ...
            foreach (Newtral newtral in loli)
            {
                    ...
                    )
                {
                    for (int i = 0; i < loli.Count; i++)
                    {
                        ...
                        isNewtralHit = true;
                        gameEnd = true;
                        ScreenManager.AddScreen(new LoseScreen(content,"stateThree"));
        ...
        public void LoadEnemies()
        {
            ...
            if (spawn >= 2)
            {
                ...
                if (jejemon.Count() < 4)
                {
                    jejemon.Add(new Enemy(content, new Vector2(2100, 270), "Sprites/tripod"));
                }
            }
