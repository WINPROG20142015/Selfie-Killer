    ...
    public class MainMenu : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            for (int i = 0; i < NUMBER_OF_BUTTONS; i++)
            {
                ...
                button_timer[i] = 0.0;
                button_rectangle[PLAY_BUTTON_INDEX] = new Rectangle(150, 525, BUTTON_WIDTH, BUTTON_HEIGHT);
                button_rectangle[QUIT_BUTTON_INDEX] = new Rectangle(500, 525, BUTTON_WIDTH, BUTTON_HEIGHT);
        ...
        public override void LoadContent()
        {
            ...
            loseBG = content.Load<Texture2D>("Backgrounds/MainMenuBg");

            button_texture[PLAY_BUTTON_INDEX] =
                content.Load<Texture2D>("Buttons/start");
            ...
            for (int i = 0; i < NUMBER_OF_BUTTONS; i++)
            {
                    ...
                    button_rectangle[i], button_texture[i], mx, my))
                {
                    ...
                    if (mpressed)
                    {
                        ...
                        button_color[i] = Color.DarkGoldenrod;
                    }
                    ...
                    else
                    {
                        ...
                        button_color[i] = Color.LightGoldenrodYellow;
                    }
                }
                else
                {
