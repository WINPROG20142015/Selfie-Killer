...
{
    public class StageOne : GameScreen
    {
        #region STAGE1 VARS
        ...
        #endregion 
        #region CONSTRUCTOR
        public StageOne(ContentManager content)
        {
        ...
        public override void Update(GameTime gameTime, bool covered)
        {
            ...
            if (!gameEnd)
            {
                ...
                //LoseScreen
                if (player.life == 0 && gameEnd == false)
                {
                    gameEnd = true;
                    ScreenManager.AddScreen(new WinScreen(content, "stateOne"));
        ...
        public void LoadEnemies()
        {
            ...
            if (spawn >= 1)
            {
                ...
                if (jejemon.Count() < 5)
                {
                    jejemon.Add(new Enemy(content, new Vector2(2100, 270), "Sprites/jeje"));
                }
            }
