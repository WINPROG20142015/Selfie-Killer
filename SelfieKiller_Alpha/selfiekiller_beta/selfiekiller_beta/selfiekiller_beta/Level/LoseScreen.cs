...
namespace selfiekiller_beta
{
    public class LoseScreen : GameScreen
    {
       // GraphicsDeviceManager graphics;
        ...
        public LoseScreen(ContentManager content, string state)
        {
        ...
        public override void LoadContent()
        {
            ...
            button_texture[MAINMENU_BUTTON_INDEX] =
                content.Load<Texture2D>("Buttons/MainMenuRed");
            button_texture[RETRY_BUTTON_INDEX] =
                content.Load<Texture2D>("Buttons/retry");
